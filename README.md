...
proving homotopy invariance of higher signatures through an admissible assembly-signature closure architecture.

## Main Manuscript

- [paper/NOVIKOV_CONJECTURE_PREPRINT.md](paper/NOVIKOV_CONJECTURE_PREPRINT.md)
- [paper/CANONICAL_ROUTING_INDEX.md](paper/CANONICAL_ROUTING_INDEX.md)

## Structure

- `paper/`
  - `NOVIKOV_CONJECTURE_PREPRINT.md`
...
1. Theorem chain first: read `paper/NOVIKOV_CONJECTURE_PREPRINT.md`.
...
Current NOV runner policy:

- `repro/run_repro.sh` extracts, promotes, runs `scripts/nov_closure_guard.py`, updates `repro/repro_manifest.json`, and enforces `fully_extracted` release-gate mode.
...
3. artifact key consumed by `scripts/nov_closure_guard.py`.
...
- Manuscript target: [paper/NOVIKOV_CONJECTURE_PREPRINT.md](paper/NOVIKOV_CONJECTURE_PREPRINT.md)
