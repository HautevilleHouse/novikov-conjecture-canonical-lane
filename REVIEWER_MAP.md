# Reviewer Map
    ...
    6. Scalar closure: `NOV_G1, NOV_G2, NOV_G3, NOV_G4, NOV_G5, NOV_G6, NOV_GM` all `PASS`.

    Primary files:

    - `paper/NOVIKOV_CONJECTURE_PREPRINT.md`
    - `notes/EG1_public.md`
    - `notes/EG2_public.md`
    - `notes/EG3_public.md`
    - `notes/EG4_public.md`
...
| `NOV_G6` | `eps_coh` | strict coherence / identification closure |
| `NOV_GM` | derived | final strict margin |
