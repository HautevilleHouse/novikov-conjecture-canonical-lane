...
mkdir -p .repro_tmp/novikov_conjecture
cp artifacts/stitch_constants.json .repro_tmp/novikov_conjecture/stitch_constants.json
cp artifacts/constants_registry.json .repro_tmp/novikov_conjecture/constants_registry.json
