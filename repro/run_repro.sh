...
mkdir -p .tmp/novikov_conjecture
cp artifacts/stitch_constants.json .tmp/novikov_conjecture/stitch_constants.json
cp artifacts/constants_registry.json .tmp/novikov_conjecture/constants_registry.json
